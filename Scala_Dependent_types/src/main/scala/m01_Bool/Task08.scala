...
object Task08 {
  ...
  val beta1 = "ind(c1)(c2)(true)=???" :: C ~>: c1 ~>: c2 ~>: Id(C(tru))(ind(C)(c1)(c2)(tru))(c1)
  val beta2 = "ind(c1)(c2)(false)=???" :: C ~>: c1 ~>: c2 ~>: Id(C(fls))(ind(C)(c1)(c2)(fls))(c2)
  ...
  val lemma1 = map(Bool)( not(tru) )(fls)( not_tru_eq_fls )(Bool)(b :-> not(b))  !:
      Id(Bool)( not(not(tru)) )( not(fls) )
  val lemma2 = trans(Bool)( not(not(tru)) )( not(fls) )(lemma1)(tru)( not_fls_eq_tru ) !:
      not_not_b_eq_b(tru)

  val lemma3 = map(Bool)( not(fls) )(tru)( not_fls_eq_tru )(Bool)(b :-> not(b))  !:
      Id(Bool)( not(not(fls)) )( not(tru) )
  val lemma4 = trans(Bool)( not(not(fls)) )( not(tru) )(lemma3)(fls)( not_tru_eq_fls ) !:
      not_not_b_eq_b(fls)
